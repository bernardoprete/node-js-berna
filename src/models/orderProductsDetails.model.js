...
export const OrderProductsDetailsModel = {
  ...
  async create({ cantidad, precioUnitario, idPedido, idProducto, subtotal }, connection) { //pasamos conexion, tambien.
    try {
     
      const sql = `INSERT INTO ${this.tablename} 
      (${this.fields.cantidad}, ${this.fields.precioUnitario}, ${this.fields.idPedido}, ${this.fields.idProducto}, ${this.fields.subtotal})
      VALUES (?, ?, ?, ?, ?)`;
      ...
      throw createError(500, "Error al intentar crear el detalle del pedido.");
    }
  },
};