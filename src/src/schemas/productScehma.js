...
export const createProductSchema = z.object({
  ...
  // Aca no deberia validar que la fecha de ofertaHasta sea > que la fecha de creacion de la oferta o sea la fecha actual? DUDAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA
  ...
  imgPrincipal: z
    ...
    .trim()
    .min(1, { message: "La imagen principal es requerida." }), //ACA EL MIN 1 QUIERE DECIR QUE LA LONGITUD DE ESE STRING ES MINIMO 1, EN OTRAS PALABRAS NO PUEDE ESTAR VACIO
...
// Si viene "oferta hasta" entonces esa fecha debe ser si o si un dia futuro al de hoy. HACER CON REFINEEEEEEEEEEEEEEEEEEEEEEEEEEEEE
